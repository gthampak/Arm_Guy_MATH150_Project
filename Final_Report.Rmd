...
We reject the null hypothesis that factors affecting health perception and perception on healthcare are unrelated to the likelihood of a person linking with primary heatlchare at any given time, with all else being constant as shown by significant variables discussed and included in mode.
